        ...
        <div className="space-y-6 py-4">
          ...
          <section className="p-4 rounded-lg bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20">
            ...
            <p className="text-sm text-[var(--text-secondary)] mb-3">
              Research shows that Large Language Models pay <strong className="text-[var(--text-primary)]">more attention 
            ...
            <div className="flex items-center justify-center gap-2 p-3 bg-[var(--bg-primary)] rounded-lg">
              ...
              <div className="px-3 py-1.5 rounded bg-[var(--bg-tertiary)] text-[var(--text-muted)] text-xs font-medium">
                Lower Attention
              </div>
              <ArrowRight className="w-4 h-4 text-[var(--text-muted)]" />
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="flex gap-3 p-3 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-color)]">
                <div className="w-8 h-8 rounded-lg bg-green-500/20 flex items-center justify-center flex-shrink-0">
                  <span className="text-green-500 font-semibold text-sm">1</span>
                </div>
                <div>
                  <h4 className="text-sm font-medium text-[var(--text-primary)]">Place Important Files First (Primacy)</h4>
              ...
              <div className="flex gap-3 p-3 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-color)]">
                ...
                <div>
                  <h4 className="text-sm font-medium text-[var(--text-primary)]">Keep Key Code at the End (Recency)</h4>
                  <p className="text-xs text-[var(--text-muted)] mt-0.5">
              ...
              <div className="flex gap-3 p-3 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-color)]">
                ...
                <div>
                  <h4 className="text-sm font-medium text-[var(--text-primary)]">Less Critical Files in the Middle</h4>
                  <p className="text-xs text-[var(--text-muted)] mt-0.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-color)]">
                <div className="flex items-center gap-2 mb-1">
                  <ListOrdered className="w-4 h-4 text-[var(--accent-color)]" />
                  <span className="text-sm font-medium text-[var(--text-primary)]">Organize Context</span>
                </div>
              ...
              <div className="p-3 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-color)]">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm font-medium text-[var(--text-primary)]">Privacy Filter</span>
                </div>
                <p className="text-xs text-[var(--text-muted)]">
              ...
              <div className="p-3 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-color)]">
                <div className="flex items-center gap-2 mb-1">
                  <Copy className="w-4 h-4 text-[var(--accent-color)]" />
                  <span className="text-sm font-medium text-[var(--text-primary)]">Prompt Templates</span>
                </div>
                <p className="text-xs text-[var(--text-muted)]">
              ...
              <div className="p-3 rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-color)]">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm font-medium text-[var(--text-primary)]">Token Tracking</span>
                </div>
                <p className="text-xs text-[var(--text-muted)]">
          ...
          {/* Pro Tips */}
          <section className="p-4 rounded-lg bg-[var(--bg-tertiary)] border border-[var(--border-color)]">
            <h3 className="text-sm font-semibold text-[var(--text-primary)] mb-2">💡 Pro Tips</h3>
