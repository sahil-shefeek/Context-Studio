...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2 py-0.5 text-[10px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-(--accent-color) focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-(--accent-color) text-white",
        secondary:
        ...
        muted:
          "border-transparent bg-(--bg-secondary) text-(--text-muted)",
      },
    },
    defaultVariants: {
      variant: "default",
